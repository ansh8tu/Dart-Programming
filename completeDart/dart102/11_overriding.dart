void main() {
  ...
  //calling the overriden functions
  // prints Overriding the toString() method in parent class!
  print(studentOne.toString());

  // prints Overriding the toString() method in child class!
  print(studentPhysics.toString());
}
...
class Student {
  ...
  @override
  String toString() => "Overriding the toString() method in parent class!";
}
...
class PhysicsStudent extends Student {
  ...
  @override
  String toString() => "Overriding the toString() method in child class!";
}
